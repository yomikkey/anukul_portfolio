...
const IconParkSolidClickIcon3 = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 31 31' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    ...
    >
      ...
      />
      <path
        d='M24.6334 6.36664L20.9799 10.0201M6.36663 24.6334L10.0201 20.9799M2.58333 15.5H7.75M6.36663 6.36664L10.0201 10.0201'
        stroke='white'
        strokeWidth={4}
        strokeLinecap='round'
        strokeLinejoin='round'
...
const Memo = memo(IconParkSolidClickIcon3);
export { Memo as IconParkSolidClickIcon3 };
