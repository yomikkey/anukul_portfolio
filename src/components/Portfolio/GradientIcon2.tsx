...
const GradientIcon2 = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 625 700' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    <ellipse cx={312.5} cy={350} rx={312.5} ry={350} fill='url(#paint0_radial_104_158)' />
    <defs>
      <radialGradient
        id='paint0_radial_104_158'
        cx={0}
        cy={0}
        r={1}
...
const Memo = memo(GradientIcon2);
export { Memo as GradientIcon2 };
